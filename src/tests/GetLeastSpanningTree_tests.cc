...
TEST(GraphAlhorithms, GetLeastSpanningTree) {
  s21::Graph graph;
  graph.LoadGraphFromFile("examples/least_spanning_tree.txt");

  s21::Graph expected_graph;
  expected_graph.LoadGraphFromFile("examples/least_spanning_tree_result.txt");
